...
class MainController extends BaseMainController {
  ...
  void mainTabItems() {
    ...
    tabItems.add(MainTabItem(
        ...
        iconSelected: Assets.cfox.tabVideoLottie,
        selectedLottie: true));
    ...
    tabItems.add(MainTabItem(
        ...
        iconSelected: Assets.cfox.tabDouyinLottie,
        selectedLottie: true));
    ...
    tabItems.add(MainTabItem(
        ...
        iconSelected: Assets.cfox.tabGameLottie,
        selectedLottie: true));
    ...
    tabItems.add(MainTabItem(
        ...
        iconSelected: Assets.cfox.tabCommunityLottie,
        selectedLottie: true));
    ...
    tabItems.add(MainTabItem(
        ...
        iconSelected: Assets.cfox.tabMineLottie,
        selectedLottie: true));
  }
}
